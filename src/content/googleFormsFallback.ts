...
export const UNSUPPORTED_GOOGLE_FORM_OVERLAY_ID =
  "smart-form-autofill-unsupported-google-form";
 ...
 */
export function showUnsupportedGoogleFormOverlay(
 ...
 */
export function getGoogleFormsAdapterOrShowFallback(): GoogleFormsAdapter | null {
  ...
  showUnsupportedGoogleFormOverlay();
  return null;
}
